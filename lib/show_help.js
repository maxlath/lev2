...
Options:
  ...
  -k, --keys                              List all the keys in the current range

  -v, --values                            List all the values in the current range.
                                          Emit as a new-line delimited stream of json.

  -a, --all                               List all the keys and values in the current range.
                                          Emit as a new-line delimited stream of json.
  ...
  -n, --limit                             Limit the number of records emitted in the current range
